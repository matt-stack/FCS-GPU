...
///////////////////////////////////////////////////////////////////////
void TransformationChainPlots( TTree* InputTree_Id, std::string VarPlotted_Id, TTree* InputTree_Uniform,
                               std::string VarPlotted_Uniform, TTree* InputTree_Gauss, std::string VarPlotted_Gauss,
                               TH1F* Cumulative, std::string output ) {
  ///////////////////////////////////////////////////////////////////////
...
void ToySimulation1( TFile* input, TFile* input2 ) {
  ...
  for ( int k = 0; k < 25; k++ ) {
    ...
    if ( T_Gauss->GetBranch( Form( "data_Gauss_%i", k ) ) != NULL ) {
      ...
      Cumulative[tmp] = (TH1F*)input->Get( Form( "hCumulative%i", k ) );
      Cumulative[tmp]->Print();
      ...
      /* vector<double> Bins;
       ...
       InvertCumulative[tmp] = new TH1F(Form("InvertCumulative%i",k), Form("InvertCumulative%i",k),
       Bins.size(),&Bins[0]);
       XXX
...
void PCA_Validation( TString InputFile = "PCAOutput.root", TString InputFile2 = "PCA_transformation_inputs.root" ) {
  ...
  for ( int i = 0; i < 25; i++ ) {
    if ( T_Id->GetBranch( Form( "data_%i", i ) ) != NULL &&
         T_Uniform->GetBranch( Form( "data_Uniform_%i", i ) ) != NULL &&
         T_Gauss->GetBranch( Form( "data_Gauss_%i", i ) ) != NULL ) {
      ...
      TransformationChainPlots( T_Id, VarPlotted_Id, T_Uniform, VarPlotted_Uniform, T_Gauss, VarPlotted_Gauss,
                                Cumulative, output );
  ...
  for ( int i = 0; i < 25; i++ ) {
    for ( int j = i; j < 25; j++ ) {
      if ( T_Id->GetBranch( Form( "data_%i", i ) ) != NULL && T_Id->GetBranch( Form( "data_%i", j ) ) != NULL &&
           i != j ) {
  ...
  for ( int i = 0; i < 25; i++ ) {
    for ( int j = i; j < 25; j++ ) {
      if ( T_Uniform->GetBranch( Form( "data_Uniform_%i", i ) ) != NULL &&
           T_Uniform->GetBranch( Form( "data_Uniform_%i", j ) ) != NULL && i != j ) {
  ...
  for ( int i = 0; i < 25; i++ ) {
    for ( int j = i; j < 25; j++ ) {
      if ( T_Gauss->GetBranch( Form( "data_Gauss_%i", i ) ) != NULL &&
           T_Gauss->GetBranch( Form( "data_Gauss_%i", j ) ) != NULL && i != j ) {
  ...
  for ( int i = 0; i < 25; i++ ) {
    for ( int j = i; j < 25; j++ ) {
      if ( T_PCA->GetBranch( Form( "PCA_%i", i ) ) != NULL && T_PCA->GetBranch( Form( "PCA_%i", j ) ) != NULL &&
           i != j ) {
