...
private:
  ...
  // ISF_FCS_Parametrization::FCS_StepInfoCollection* copyFCS_StepInfo(const
  // ISF_FCS_Parametrization::FCS_StepInfoCollection* stepinfo);

  // ISF_FCS_Parametrization::FCS_StepInfoList* copyFCS_StepInfoZeroCleanup(const
  // ISF_FCS_Parametrization::FCS_StepInfoCollection* stepinfo);
