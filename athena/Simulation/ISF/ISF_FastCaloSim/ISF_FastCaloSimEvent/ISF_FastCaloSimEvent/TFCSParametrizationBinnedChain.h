...
public:
  TFCSParametrizationBinnedChain( const char* name = nullptr, const char* title = nullptr )
      : TFCSParametrizationChain( name, title ), m_bin_start( 1, 0 ){};
  TFCSParametrizationBinnedChain( const TFCSParametrizationBinnedChain& ref )
      : TFCSParametrizationChain( ref ), m_bin_start( ref.m_bin_start ){};
  ...
  virtual const std::string get_variable_text( TFCSSimulationState&, const TFCSTruthState*,
  ...
  static void unit_test( TFCSSimulationState* simulstate = nullptr, const TFCSTruthState* truth = nullptr,
