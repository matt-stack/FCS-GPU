...
public:
  ...
  static double CheckAndIntegrate1DHistogram( const TH1* hist, std::vector<double>& integral_vec, int& first,
                                              int& last );

  static TH1* generate_histogram_random_slope( int nbinsx = 50, double xmin = 0, double xmax = 1,
                                               double zerothreshold = 0.1 );
  static TH1* generate_histogram_random_gauss( int nbinsx = 50, int ntoy = 100000, double xmin = 1, double xmax = 5,
