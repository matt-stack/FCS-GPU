...
public:
  ...
  virtual const CaloDetDescrElement* getDDE( int sampling, float eta, float phi, float* distance = 0,
                                             int* steps = 0 )      = 0;
  virtual const CaloDetDescrElement* getFCalDDE( int sampling, float x, float y, float z, float* distance = 0,
                                                 int* steps = 0 )  = 0;
