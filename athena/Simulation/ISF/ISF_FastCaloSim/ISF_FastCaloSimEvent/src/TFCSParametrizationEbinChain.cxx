...
const std::string TFCSParametrizationEbinChain::get_variable_text( TFCSSimulationState& simulstate,
                                                                   const TFCSTruthState*,
                                                                   const TFCSExtrapolationState* ) const {
  return std::string( Form( "Ebin=%d", simulstate.Ebin() ) );
}

void TFCSParametrizationEbinChain::unit_test( TFCSSimulationState* simulstate, const TFCSTruthState* truth,
