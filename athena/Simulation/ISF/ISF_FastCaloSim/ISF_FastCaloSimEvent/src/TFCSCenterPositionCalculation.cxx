...
TFCSCenterPositionCalculation::TFCSCenterPositionCalculation( const char* name, const char* title )
    : TFCSLateralShapeParametrizationHitBase( name, title ), m_extrapWeight( 0.5 ) {}

FCSReturnCode TFCSCenterPositionCalculation::simulate_hit( Hit& hit, TFCSSimulationState& /*simulstate*/,
  ...
  ATH_MSG_DEBUG( "TFCSCenterPositionCalculation: center_r: "
                 << hit.center_r() << " center_z: " << hit.center_z() << " center_phi: " << hit.center_phi()
                 << " center_eta: " << hit.center_eta() << " weight: " << m_extrapWeight << " cs: " << cs );
