...
TFCSEnergyInterpolationLinear::TFCSEnergyInterpolationLinear( const char* name, const char* title )
    : TFCSParametrization( name, title ), m_slope( 1 ), m_offset( 0 ) {}

FCSReturnCode TFCSEnergyInterpolationLinear::simulate( TFCSSimulationState& simulstate, const TFCSTruthState* truth,
...
void TFCSEnergyInterpolationLinear::unit_test( TFCSSimulationState* simulstate, TFCSTruthState* truth,
