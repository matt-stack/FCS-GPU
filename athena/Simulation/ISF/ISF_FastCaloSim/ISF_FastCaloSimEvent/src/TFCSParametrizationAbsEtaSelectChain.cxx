...
int TFCSParametrizationAbsEtaSelectChain::get_bin( TFCSSimulationState&, const TFCSTruthState*,
...
void TFCSParametrizationAbsEtaSelectChain::unit_test( TFCSSimulationState* simulstate, TFCSTruthState* truth,
