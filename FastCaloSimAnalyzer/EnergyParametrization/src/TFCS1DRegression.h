...
class TFCS1DRegression
{
  public:
    ...
    static void storeRegression(std::string, std::vector<std::vector<double> > &fWeightMatrix0to1, std::vector<std::vector<double> > &fWeightMatrix1to2);
    static void get_weights(std::string weightfile, std::vector<std::vector<double> > &fWeightMatrix0to1, std::vector<std::vector<double> > &fWeightMatrix1to2);
