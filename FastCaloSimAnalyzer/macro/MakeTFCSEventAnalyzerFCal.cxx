...
void MakeTFCSEventAnalyzerFCal() {
  ...
  // energy = "E50000";
  std::string eta = "eta400_405";
  // eta = "eta250_250";
  std::string production = "InputSamplesLocalProd2017";
  std::string release    = "rel_21_0_46";
  ...
  // plotDir = "/Users/ahasib/Remote/fcscernbox/www/";
#endif
  ...
  string pcaDir        = "PCAs/";
  string flatSampleDir = "flatSamples/";
  string InputPlotsDir = "InputValidationPlots/" + label + "/";
  ...
  TFCSFlatNtupleMaker* analyze = new TFCSFlatNtupleMaker( inputChain, flatSample, v_layer );
  ...
  std::cout << " * Running on " << flatSample << " with entries =" << inputTree->GetEntries() << std::endl;
  ...
  TFCSInputValidationPlots* validate = new TFCSInputValidationPlots( inputTree, InputPlotsDir, v_layer );
