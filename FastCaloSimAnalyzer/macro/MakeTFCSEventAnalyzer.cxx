...
void MakeTFCSEventAnalyzer() {
  ...
  string InputPlotsDir = plotDir + production + "/" + release + "/InputValidationPlots/" + label + "/";
  ...
  // TFCS2DParametrization* shapepara = new TFCS2DParametrization(inputTree, shapeParaFile.Data(), v_layer);
