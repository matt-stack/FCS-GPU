...
namespace FCS_dsid {
  ...
  std::string get_dsid_input_wildcard( std::string dsid, std::string basedir = input_basedir );
  int         wildcard_add_files_to_chain( TChain* chain, std::string filenames );

  std::string get_dsid_shapename( std::string dsid, std::string basedir = dsid_basedir,
                                  std::string version = dsid_version );
  std::string get_dsid_avg_sim_shapename( std::string dsid, std::string basedir = dsid_basedir,
                                          std::string version = dsid_version );
  std::string get_dsid_firstPCAname( std::string dsid, std::string basedir = dsid_basedir,
                                     std::string version = dsid_version );
  std::string get_dsid_firstPCA_Appname( std::string dsid, std::string basedir = FirstPCA_App_basedir,
                                         std::string version = FirstPCA_version );
  std::string get_dsid_secondPCAname( std::string dsid, std::string basedir = dsid_basedir,
                                      std::string version = dsid_version );

  std::string get_wiggle_name( std::string etarange, int sampling, bool isNewWiggle = is_NewWiggle,
                               std::string basedir = dsid_basedir, std::string version = wiggle_version );
