...
public:
  TFCSSimulationRun( const char* name = 0, const char* title = 0 )
      : TNamed( name, title ), m_basesim( 0 ), m_simul( 0 ){};
  TFCSSimulationRun( const char* name, const char* title, TFCSParametrizationBase* ref )
      : TNamed( name, title ), m_basesim( ref ), m_simul( 0 ){};
  TFCSSimulationRun( TFCSParametrizationBase* ref ) : TNamed( *ref ), m_basesim( ref ), m_simul( 0 ){};
  TFCSSimulationRun( TFCSParametrizationBase* ref, std::vector<TFCSSimulationState>& refsimul )
      : TNamed( *ref ), m_basesim( ref ), m_simul( refsimul ){};
